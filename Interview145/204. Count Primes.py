...
Algorithm:
My code is based on the Sieve of Eratosthenes which is efficient yet very simple. 
Make sure to read the link as well as the hints in the description of this question to better understand 
the Mathmatics of the code. Here, I do not want to explain the algorithm, instead I am focused on how to
make the code as fast as possible.

Make your code faster:
The code line lst[m * m: n: m] = [0] *((n-m*m-1)//m + 1) is key to reduce the run time. 
